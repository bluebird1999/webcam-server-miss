 ...
 * define
 */
#define		SERVER_MISS_VERSION_STRING			"alpha-4.10"
...
#define		MSG_MISS_BUFFER_FULL				(MSG_MISS_BASE | 0X0030)
...
#define		MISS_ASYN_VIDEO2_START			0x03
#define		MISS_ASYN_VIDEO2_STOP			0x04
#define		MISS_ASYN_VIDEO2_CTRL			0x05
